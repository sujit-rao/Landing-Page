    ...
    return (
        <div className=' md:px-14 p-4 max-w-s mx-auto space-y-10 ' id='about'>
            ...
            <div className=' flex flex-col md:flex-row-reverse justify-between items-center gap-8'>
                ...
                <motion.div variants={fadeIn("right", 0.2)} initial='hidden' whileInView={"show"}
                    viewport={{ once: false, amount: 0.7 }} className=' md:w-2/5'>
                    <h2 className=' md:text-5xl text-3xl font-bold text-primary mb-5 leading-normal '>You can Practice at any time <span className=' text-secondary'>convinent for you</span></h2>
                    <p className=' text-tartiary text-lg mb-7'>A good example of a paragraph contains a topic conclusion. 'There are many different kinds of animals that live in China. </p>
                    <button className='btnPrimary'>Get Started</button>
                </motion.div>
            </div>
